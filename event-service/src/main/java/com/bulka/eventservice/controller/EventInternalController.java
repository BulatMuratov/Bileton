...
public class EventInternalController {
    ...
    public void sellSeats(
        ...
        eventInternalService.sellSeats(eventId, eventSeatIds);
    }

    @PostMapping("/{eventId}/seats/cancelSell")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void cancelSellSeats(
            @PathVariable UUID eventId,
            @RequestBody List<UUID> eventSeatIds
    ){
        eventInternalService.cancelSellSeats(eventId, eventSeatIds);
    }
